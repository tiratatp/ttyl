...
// in simulator we redefine to format for ttylNEW Developer console
...
{\
	NSString * exceptionName = [@"org.ttylnew." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.ttylnew";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIttylNEWNativeItemNone = -1, 
	UIttylNEWNativeItemSpinner = -2,
	UIttylNEWNativeItemProgressBar = -3,
	
	UIttylNEWNativeItemSlider = -4,
	UIttylNEWNativeItemSwitch = -5,
	UIttylNEWNativeItemMultiButton = -6,
	UIttylNEWNativeItemSegmented = -7,
	
	UIttylNEWNativeItemTextView = -8,
	UIttylNEWNativeItemTextField = -9,
	UIttylNEWNativeItemSearchBar = -10,
	
	UIttylNEWNativeItemPicker = -11,
	UIttylNEWNativeItemDatePicker = -12,
	
	UIttylNEWNativeItemInfoLight = -13,
	UIttylNEWNativeItemInfoDark = -14,
	
	UIttylNEWNativeItemDisclosure = -15,
	
	UIttylNEWNativeItemContactAdd = -16
};

...
//@interface ttylNEWObject : NSObject
//@end

@interface ttylNEWObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ttylNEWObject class]])
		{
			for (NSString *key in [[(ttylNEWObject*)o modules] allKeys])
			{
